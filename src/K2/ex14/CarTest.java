...
class CarCollection {
    ...
    public void addCar(Car car) {
        String m = car.getManufacturer().toLowerCase();
        cars.add(car);
    }
    ...
    public List<Car> filterByManufacturer(String manufacturer) {
        ...
        for (Car car : cars) {
            if(car.getManufacturer().toLowerCase().equals(manufacturer.toLowerCase())){
                filtered.add(car);
            }
        }
        filtered.sort(Comparator.comparing(Car::getModel));
        return filtered;
    }
}